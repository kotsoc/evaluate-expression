...
public class ExpressionEvaluatorTest {
    ...
    public void testLargeNumbers() {
        String result = evaluator.evaluate("10000000000000000 * 200000000000000001");
        assertEquals("2000000000000000010000000000000000", result);
    }
    
    @Test
    public void testZeroPlusZero() {
        String result = evaluator.evaluate("0 + 0 * 0");
        assertEquals("0", result);
    }
}
